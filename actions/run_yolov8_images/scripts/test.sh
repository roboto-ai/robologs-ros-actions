...
main() {
    ...
    # Test 1
    echo "Running Test 1: Verify that detections.json and video.mp4 are created"
    clean_actual_output
    run_docker_test ""
    file_exists_or_error $ACTUAL_OUTPUT_DIR/folder1/folder2/detections.json
    # Check second
    file_exists_or_error $ACTUAL_OUTPUT_DIR/folder1/folder2/video.mp4
