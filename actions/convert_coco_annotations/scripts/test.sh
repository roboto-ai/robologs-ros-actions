...
main() {
    # Test 1
    echo "Running Test 1: Test with ROBOTO_PARAM_OUTPUT_FILE_NAME=detections123.json"
    clean_actual_output
    run_docker_test "-e ROBOTO_PARAM_OUTPUT_FILE_NAME=detections123.json"
    file_exists_or_error $ACTUAL_OUTPUT_DIR/detections123.json
