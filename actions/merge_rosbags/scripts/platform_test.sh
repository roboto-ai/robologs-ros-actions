...
INPUT_FILE_PATH2="./test/input/tiny.bag"
EXPECTED_OUTPUT_FILE_NAME="merged.bag"
INPUT_DATA="*bag"
ORG=${ORG}
...
roboto datasets upload-files -d "$dataset_id" -p "$INPUT_FILE_PATH1"
roboto datasets upload-files -d "$dataset_id" -p "$INPUT_FILE_PATH2"
