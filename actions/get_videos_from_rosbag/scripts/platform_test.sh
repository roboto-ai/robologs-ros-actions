...
EXPECTED_OUTPUT_FILE_NAME="video.mp4"
INPUT_DATA="*bag"
ORG=${ORG}
...
invoke_output=$(roboto actions invoke "$ACTION_NAME" --parameter-value SAVE_VIDEO=True --dataset-id "$dataset_id" --input-data "$INPUT_DATA" --org "$ORG")
